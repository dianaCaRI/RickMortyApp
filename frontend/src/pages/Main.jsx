...
useEffect(()=>{
  const getGames = async () => {
    const url= `https://api.rawg.io/api/games?key=39cc91002d86485594199d96f46abf51`
        ...
        {games.map((game,index)=>{
          return(
            ...
            <div className="flex flex-col justify-between p-4 leading-normal">
                ...
                <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Calificacion: {game.metacritic}</p>
            </div>
        </a>
          )
        })}
